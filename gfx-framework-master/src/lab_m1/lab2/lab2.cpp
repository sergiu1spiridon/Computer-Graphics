...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
           ...
           VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.0)),
           VertexFormat(glm::vec3(0, 0,  1), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.1)),
           VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.2)),
           VertexFormat(glm::vec3(1, 0,  1), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.3)),
           VertexFormat(glm::vec3(0, -1,  0), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.4)),
           VertexFormat(glm::vec3(0, -1,  1), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.5)),
           VertexFormat(glm::vec3(1, -1,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
           VertexFormat(glm::vec3(1, -1,  1), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.7)),
        };
...

    {
        ...
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(2, 2, 2), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.0)),
            VertexFormat(glm::vec3(4, 2, 2), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.0)),
            VertexFormat(glm::vec3(2, 4, 2), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.0)),
            VertexFormat(glm::vec3(2, 2, 4), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.0)),
        ...
        meshes["tetrahedru"] = new Mesh("generated tetrahedron");
        meshes["tetrahedru"]->InitFromData(vertices, indices);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetrahedru"], shaders["VertexColor"], glm::vec3(-1.5f, 0.5f, 0), glm::vec3(0.25f));
